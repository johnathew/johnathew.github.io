export const HeroDescription = () => (
    <section id="about" className="h-full mt-30 md:min-w-1/2 w-full px-4 items-center flex flex-col" aria-labelledby="about-heading">
        ...
        <p className="text-slate-50 text-center py-2 font-extralight text-sm/7 md:text-lg/7 md:w-1/2 sm:w-3/4 w-full" aria-label="Introduction about John Kornegay">
        ...
        <p className="text-slate-50 text-center py-2 font-extralight text-sm/7 md:text-lg/7 md:w-1/2 sm:w-3/4 w-full" aria-label="Additional information about John Kornegay">
        ...
        <p className="text-slate-50 text-center py-2 font-extralight text-sm/7 md:text-lg/7 md:w-1/2 sm:w-3/4 w-full" aria-label="Contact information for John Kornegay">
