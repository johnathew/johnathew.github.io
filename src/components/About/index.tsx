export const About = () => (
    <section id="about" className="w-full px-4 items-center flex flex-col" aria-labelledby="about-heading">
        ...
        <p className="text-slate-50 text-center py-2 font-extralight text-sm/7 md:text-lg/7 sm:w-1/2 w-full">
            ...
            As a software developer with a passion for technology, I enjoy coding, problem-solving, being creative, and learning new things.
